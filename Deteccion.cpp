...
void Deteccion::SVMPrediccion(string imagen, string svmFile){
    ...
    if(r>0.0){
        putText(imgColor, "Es responsable USA CASCO", Point(30,30), FONT_HERSHEY_PLAIN, 1, Scalar(255,10,10),2);
    }else if(r<0.0){
        putText(imgColor, "Persona irresponsable NO USA CASCO", Point(30,30), FONT_HERSHEY_PLAIN, 1, Scalar(10,10,255),2);
    }
    imshow("Img",img);
